...
public class Lab3Bai4 {
	...
	public static void main(String[] args) {
		...
		ArrayList<Lab3Bai4> danhSach = new ArrayList();

		for (int i = 0; i < n; i++) {
			input.nextLine();
			Lab3Bai4 x = new Lab3Bai4();
		...
		Collections.sort(danhSach, new Comparator<Lab3Bai4>() {
			public int compare(Lab3Bai4 sv1, Lab3Bai4 sv2) {
